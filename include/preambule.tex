...
%\expandafter\let\expandafter\oldstarsection\csname section*\endcsname
...
\renewcommand{\section}{\@ifstar{\mynewstarsection}{\mynewsection}}
...
\mode<presentation>
{
	...
	\newminted[cmdcode]{text}{ frame=single, autogobble=true, xleftmargin=0.1pt, rulecolor=black,formatcom=\color{white} , framerule=1ex,framesep=0pt, bgcolor=black, style=vs,tabsize=2,fontsize=\small,escapeinside=\@\@}
	
	\newminted[cmdcodefootnotesize]{text}{ frame=single, autogobble=true, xleftmargin=0.1pt, rulecolor=black,formatcom=\color{white} , framerule=1ex,framesep=0pt, bgcolor=black, style=vs,tabsize=2,fontsize=\footnotesize,escapeinside=\@\@}
	
	\newminted[dockerfile]{docker}{linenos,  autogobble=true, style=vs,tabsize=2,fontsize=\small,escapeinside=\@\@,xleftmargin=0em, numbersep=0.5em}
